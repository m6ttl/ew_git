...
class CityDict(models.Model):
    name = models.CharField(max_length=20, verbose_name=u"知识来源")
    # 分类描述：备用不一定展示出来
...
class CourseOrg(models.Model):
    ...
    # 一个知识来源可以有很多课程类型，通过将city设置外键，变成课程类型的一个字段
    # 可以让我们通过类型找到分类
    city = models.ForeignKey(CityDict, on_delete=models.CASCADE, verbose_name=u"知识来源")
