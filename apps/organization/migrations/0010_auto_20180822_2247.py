...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='citydict',
            options={'verbose_name': '知识来源', 'verbose_name_plural': '知识来源'},
        ),
        migrations.AlterField(
            model_name='citydict',
            name='name',
            field=models.CharField(max_length=20, verbose_name='知识来源'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='courseorg',
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CityDict', verbose_name='知识来源'),
        ),
        migrations.AlterField(
            model_name='courseorg',
            name='tag',
