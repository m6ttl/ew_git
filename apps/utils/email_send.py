...
def send_register_eamil(email, send_type="register"):
    ...
    if send_type == "register":
        email_title = "易维科技知识库 注册激活链接"
        # email_body = "欢迎注册易维科技的知识库:  请点击下面的链接激活你的账号: http://127.0.0.1:8000/active/{0}".format(code)
